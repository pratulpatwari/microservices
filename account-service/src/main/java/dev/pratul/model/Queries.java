...
public final class Queries {
	...
	public final static String GET_ACCOUNTS_BY_USER = "select acc.id as id," + " acc.acc_id as acc_id,"
	...
	public final static String GET_ACCOUNT_DETAILS = "select acc.id as id," + " acc.acc_id as acc_id,"
